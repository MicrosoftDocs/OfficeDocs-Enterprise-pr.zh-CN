...
12. 在 "详细信息" 窗格中，单击 "**预览搜索结果**" 以查看找到的项目。 这可能会帮助您识别您要查找的项目。 如果找到要尝试恢复的项目，请转到步骤4，将搜索结果导出到 PST 文件。 
...
## <a name="optional-step-3-copy-the-search-results-to-a-discovery-mailbox"></a>Optional步骤3：将搜索结果复制到发现邮箱
<a name="step3"> </a>
