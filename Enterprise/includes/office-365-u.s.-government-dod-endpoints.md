...
不足 | 默认<BR>必填 | 否 | `statics.teams.microsoft.com` | **TCP：** 443
...
位 | 允许<BR>必填 | 是 | `*.osi.apps.mil`<BR>`52.127.72.0/21, 2001:489a:2206::/48` | **TCP：** 443
...
上午 | 默认<BR>必填 | 否 | `dod.loki.office365.us` | **TCP：** 443
