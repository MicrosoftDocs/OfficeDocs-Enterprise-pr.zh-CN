...
ID | 类别 | ER | Addresses | 端口
-- | -------------------- | --- | ------------------------------------------------------------------------------------------------------------------------ | ----------------
第 | 优化<BR>必填 | 是 | `*.dps.mil, *.sharepoint-mil.us`<BR>`20.34.12.0/22, 104.212.48.0/23, 2001:489a:2204::/63, 2001:489a:2204:c00::/54` | **TCP：** 443、80
10 | 默认<BR>必填 | 否 | `ajax.aspnetcdn.com, g.live.com, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms, wns.windows.com` | **TCP：** 443、80
...
上午 | 默认<BR>必填 | 否 | `dod.loki.office365.us, lpcres.delve.office.com` | **TCP：** 443
