 ...
 **摘要：** 配置和演示如何 Office 365 信息权限管理保护敏感文件，即使它们发布到错误的 SharePoint Online 网站集。
...
使用[连接到 Office 365 PowerShell](https://technet.microsoft.com/library/dn975125.aspx)中的说明安装 PowerShell 模块 （如果需要），并连接到您新建的 Office 365 订阅：
...
1. 在浏览器中，转到 Office 门户[http://portal.office.com](http://portal.office.com)和登录到 Office 365 试用版订阅与全局管理员帐户。
...
1. 在“**Microsoft Office 主页**”标签页上，单击“**管理员**”磁贴。
    
2. 在**Office Admin center**选项卡上单击**管理中心 > SharePoint**。
    
3. 在**SharePoint 管理中心**选项卡上单击**新建 > 专用网站集**。
    
4. 在新的网站集窗格中，在**标题**executives URL 框中键入**Executives**在**管理员**，指定您的全局管理员帐户的名称，然后单击**确定**。
    
5. 等待，直到已创建新的网站集。完成后，复制新的执行官网站集的 URL，并将其粘贴到浏览器的新选项卡。
    
6. 在“**执行人员**”网站集的右上方，单击设置图标，然后单击“**共享**”。
    
7. 在**共享 Executives**，单击**高级**。
    
8. 在 SharePoint 组列表中，单击“**执行人员成员**”。
    
9. 在“人员和组”页中，单击“新建”********。
    
10. 在**共享 Executives**，键入**Executives**，单击**Executives**组中，，然后单击**共享**。
    
11. 关闭**人员和组**选项卡。
    
接下来，允许每个人访问销售网站集。
  
1. 从**SharePoint 管理中心**选项卡中，复制销售网站集的 URL，并将其粘贴到浏览器的新选项卡正在
    
2. 右上角，单击设置图标，然后单击**共享**。
...
6. 在**共享销售网站集**，键入**Everyone**，单击**除外部用户**，然后单击**共享**。
...
3. 在**Office 365 登录**页上，单击**使用其他帐户**。
    
4. 键入 **CEO** 帐户名及其密码，然后单击“**登录**”。
    
5. 在浏览器的新建选项卡上，键入 Executives 网站集的 URL ( **https://**\<组织名称 >**.sharepoint.com/sites/executives**)。
...
4. 将新的**SensitiveData BeforeIRM-Copy.docx**文件重命名为**SensitiveData AfterIRM.docx**。
...
3. 在**Office 365 登录**页上，单击 User5 帐户名，请键入其密码，，然后单击**登录**。
    
4. 在浏览器的新建选项卡上，键入销售网站集的 URL。
