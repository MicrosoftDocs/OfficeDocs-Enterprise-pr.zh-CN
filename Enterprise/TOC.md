...
### [用于 SharePoint 2013 的 Microsoft Azure 体系结构](microsoft-azure-architectures-for-sharepoint-2013.md)
...
### [自动为电子数据展示收集文件](automate-file-collection-for-ediscovery.md)
## [多地理位置]()
...
#### [概述：符合 GDPR 的 Office 365 信息保护](office-365-info-protection-for-gdpr-overview.md)
...
#### [构建个人数据分类架构](architect-a-classification-schema-for-personal-data.md)
#### [在 Office 365 中向个人数据应用标签](apply-labels-to-personal-data-in-office-365.md)
...
#### [用于 Skype for Business Server 的 GDPR](gdpr-for-skype-for-business-server.md)
...
#### [用于 Office Online Server 的 GDPR](gdpr-for-office-online-server.md)
#### [用于文件共享的 GDPR](gdpr-for-on-premises-file-shares.md)
...
#### [检测和修正非法授权](detect-and-remediate-illicit-consent-grants.md)
...
## [从 Office 2007 或 2010 产品升级](plan-upgrade-previous-versions-office.md)
### [Office 2010](upgrade-from-office-2010-servers-and-products.md)
#### [Office 2010 桌面版](/DeployOffice/office-2010-end-support-roadmap.md)
