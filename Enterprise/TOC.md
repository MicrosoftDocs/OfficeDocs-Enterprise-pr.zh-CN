...
### [使用 Azure Active Directory SharePoint 服务器 2016年身份验证](using-azure-ad-for-sharepoint-server-authentication.md)
### [部署 Office 365 Microsoft Azure 中的目录同步](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md)
...
## [多地区]()
### [OneDrive 的业务多地区](multi-geo-capabilities-in-onedrive-and-sharepoint-online-in-office-365.md)
#### [OneDrive 计划的业务多地区](plan-for-multi-geo.md)
#### [管理多个地理环境](administering-a-multi-geo-environment.md)
##### [添加或删除地区管理员](add-a-sharepoint-geo-admin.md)
