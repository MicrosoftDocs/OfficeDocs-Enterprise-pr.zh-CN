...
要详细了解 Office 365 多地理位置租户中的 Teams 体验，请参阅 [Office 365 OneDrive 和 SharePoint Online 支持多地理位置的租户中的 Teams 体验](https://docs.microsoft.com/microsoftteams/teams-experience-o365odb-spo-multi-geo)。
