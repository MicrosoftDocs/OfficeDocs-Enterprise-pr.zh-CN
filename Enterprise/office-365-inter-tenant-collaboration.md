...
- **许可证 &amp; 订阅：** 在 Microsoft 365 中，许可计划中的许可证（也称为 sku 或 Microsoft 365 计划）为用户提供对为这些计划定义的 Microsoft 365 服务的访问权限。 
