...
- [高可用性联合身份验证阶段 2：配置域控制器](high-availability-federated-authentication-phase-2-configure-domain-controllers.md) - 创建和配置副本 Windows Server Active Directory (AD) 域控制器和 DirSync 服务器。
