...
使用 Office 365 PowerShell 删除用户帐户时，该帐户不会被永久删除。可以在 30 天内还原已删除的用户帐户。
  
## <a name="before-you-begin"></a>准备工作

- 本主题中的步骤需要你连接到 Office 365 PowerShell。有关说明，请参阅[连接到 Office 365 PowerShell](connect-to-office-365-powershell.md)。
