...
|||
|:-------|:-----|
| **以** | [准备环境指南](https://go.microsoft.com/fwlink/?linkid=2005213) |
| **Teh** | [准备环境](https://go.microsoft.com/fwlink/?linkid=2043822) |
||||
...
|||
|:-------|:-----|
| **以** |  [在 Office 365 advisor 中验证你的域](https://aka.ms/verifyyourdomaino365) |
|||
...
## <a name="email-migration-and-protection"></a>电子邮件迁移和保护

### <a name="exchange-migration-advisor"></a>Exchange 迁移顾问

您需要使用自动工具和分步指南将邮箱从当前邮件系统移动到 Office 365 中的 Exchange Online。 我们将根据您当前的邮件系统、您要迁移的邮箱数以及计划管理用户和用户访问的方式推荐您的组织的最佳迁移路径。

|||
|:-------|:-----|
| **以** | [Office 365 邮件迁移顾问](https://aka.ms/office365setup) |
...
|||
|:-------|:-----|
| **以** |  [Gmail 联系人和日历助理](https://aka.ms/gmailcontactscalendar) <BR> |
|||
...
|||
|:-------|:-----|
| **以** |[SharePoint Online 快速入门](https://aka.ms/SPOquickstartguide) |
|||
...
|||
|:-------|:-----|
| **以** |  [Azure AD Connect advisor](https://aka.ms/aadconnectpwsync) |
|||
...
|||
|:-------|:-----|
| **以** |  [Azure AD 高级设置指南](https://aka.ms/aadpguidance) |
|||
...
|||
|:-------|:-----|
| **以** |[Office 365 组安装指南](https://aka.ms/groupsguide) |
|||
...
|||
|:-------|:-----|
| **以** | [团队部署顾问](https://aka.ms/teamsguidance) |
| **Teh** | [团队入门](https://youtu.be/ENEQzM2u_vA)|
||||
...
|||
|:-------|:-----|
| **以** |  [Skype for Business 部署顾问](https://aka.ms/skypeguidance) |
| **Teh** |  [Skype for Business 支持快速入门](https://aka.ms/cjfutd) <BR> [Skype 入门](https://aka.ms/ofg77x) |
|||
...
|||
|:-------|:-----|
| **以** |  [Yammer Enterprise 设置指南](https://aka.ms/yammerdeploy) |
|||
...
|||
|:-------|:-----|
| **以** |  [Microsoft StaffHub 安装指南](https://aka.ms/staffhubguide) |
|||
