...
## <a name="create-azure-ad-tenant-and-namespace"></a>创建 Azure AD 租户和命名空间
...
## <a name="add-a-ws-federation-identity-provider-to-the-namespace"></a>将 WS-Federation 标识提供程序添加到命名空间
...
## <a name="add-sharepoint-as-a-relying-party-application"></a>将 SharePoint 添加为信赖方应用程序
...
## <a name="configure-the-x509-certificate"></a>配置 X.509 证书
...
## <a name="create-a-claim-mapping-by-using-windows-powershell"></a>使用 Windows PowerShell 创建声明映射
...
## <a name="configure-sharepoint-for-the-new-identity-provider"></a>为新的标识提供程序配置 SharePoint
...
## <a name="verify-the-new-provider"></a>验证新的提供程序
