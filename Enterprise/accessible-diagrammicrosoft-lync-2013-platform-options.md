...
# 可访问的图 - Microsoft Lync 2013 平台选项

本文是名为 Microsoft Exchange 2013 平台选项的图的可访问文本版本，您可在[技术图表](https://technet.microsoft.com/zh-cn/library/dn635312%28v=office.15%29.aspx)中找到此图。
...
### Office 365 中与 Exchange 和 SharePoint 的 Lync 集成

#### Lync Server with Exchange Online 和 SharePoint Online
