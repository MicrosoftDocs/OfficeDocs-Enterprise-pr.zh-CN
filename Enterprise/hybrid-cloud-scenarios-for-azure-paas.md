...
![Azure 中基于 Microsoft PaaS 的混合方案](images/b003b15c-db66-4a3f-8cd9-3ab2e01601fe.png)
...
![基于 Azure PaaS 的混合应用程序](images/7d945c8e-346b-4610-8a02-dbaa9396e1f7.png)
...
### 示例 Azure PaaS 混合应用程序

图 3 显示了在 Azure 中运行的混合应用程序的示例。
  
**图 3：基于 Azure PaaS 的混合应用程序示例**

![基于 Azure PaaS 的混合应用程序示例](images/63051bbc-918b-4ae9-aa87-a43668a0067b.png)
...
## 使用 SQL Server 2016 的 Stretch Database
...
![使用 SQL Server 2016 的 Stretch Database](images/bab0812e-eef0-4667-9939-cd398d33a196.png)
