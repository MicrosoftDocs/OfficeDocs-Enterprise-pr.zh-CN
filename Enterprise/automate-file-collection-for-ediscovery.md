...
### PST 导入选项 A，Exchange Server 2013 的脚本
...
3. 在"文件位置"框中，键入您想导入的 Runbook 的路径和文件名，或者单击省略号 ( **...**) 浏览到您想导入的文件。
...
### PST 导入选项 A，用于 Exchange Server 2013
