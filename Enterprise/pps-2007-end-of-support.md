...
|**使用 Microsoft 365 的 Excel （在云中）**|**Excel 与 SharePoint Server （本地）**|
|:-----|:-----|
...
#### <a name="excel-with-microsoft-365-in-the-cloud"></a>使用 Microsoft 365 的 Excel （在云中）
